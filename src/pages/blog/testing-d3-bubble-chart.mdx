...
<CodeBlock
  ...
  code={`let width  = window.innerWidth, height = window.innerHeight;
...
![console.log of D3 simulation object](/console-log-simulation-object.png "D3 simulation object in JS console")
